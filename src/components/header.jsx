...
const MENUS = {
	...
	Developers: {
		cols: [
			{
				header: { label: 'Crypto Developer Platform', href: '#' },
				items: [
			...
			},
			{
				...
				items: [
					...
					{ icon: <StartupIcon />, title: 'Startups',           desc: "Launch your business with the leading platform in crypto",                           href: '#' },
				],
			},
		],
		featured: {
			...
			description: "Discover our complete crypto-as-a-service platform.",
			linkText: 'Learn more',
			href: '#',
		},
	},
	...
	Company: {
		cols: [
			[
				...
				{ icon: <NewsIcon />,   title: 'Blog',       desc: 'Read the latest from the platform',      href: '#' },
			],
			[
