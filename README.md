...
# Crypto Dashboard Project - React & Tailwind CSS Assignment

> [!IMPORTANT]
> **DISCLAIMER**: This is a student project created for educational purposes only. It is NOT affiliated with, endorsed by, or in any way associated with Coinbase or any other real financial entity. This application is a demonstration of frontend development skills and does not handle real financial transactions or personal data securely. **DO NOT enter real personal information or passwords.**
...
Visit a modern crypto dashboard for reference.
